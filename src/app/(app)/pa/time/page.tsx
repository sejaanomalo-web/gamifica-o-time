// /pa/time — colaborador vê o time: nome, função e pontuação do mês.
// SEM ranking competitivo (ordena alfabético). Ranking ao vivo só em /equipe (admin).
// Tem atividade ao vivo (últimas ações registradas) com realtime.
...
export default async function PaTimePage() {
  ...
  return (
    <div className="px-5 md:px-8 py-8 md:py-12 max-w-5xl mx-auto w-full">
      <span className="label-caps label-caps-muted block mb-3">Time · {mesAnoLabel(mesAno)}</span>
      <h1
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr] gap-6">
        {/* Lista do time — alfabética, sem ranking */}
          ...
          <ul className="flex flex-col gap-2">
            {time.map((c) => (
              <li
                ...
                style={{
                  background: c.ehVoce ? "rgba(201,149,58,0.06)" : "rgba(255,255,255,0.02)",
                  boxShadow: c.ehVoce
