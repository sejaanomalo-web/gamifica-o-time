// /pa — Dashboard pessoal (Início). Saudação + PA do mês + posição
// no ranking geral + nível atual + barra dentro do nível. Sem comissão,
// sem lista do time (essa fica em /pa/time).
